var base = "https://googledrive.com/host/0B2Dn2YmRCjCKampLczZ3T0hteEU/";
...
function chooseMp3OrOgg(file_name){
    if( supportsMp3() ){
        audioPlayer.src = base + "music/" + file_name + ".mp3";  // audioPlayer.src = "music/" + file_name + ".mp3";
    }
    else if( supportsOgg() ){
        audioPlayer.src = base + "music/" + file_name + ".ogg"; // audioPlayer.src = "music/" + file_name + ".ogg"           
    }
    else{
        audioPlayer.src = "";
        O("filePlaying").innerHTML = "Trouble with file or file type."    
